...
const int set_speed = 4; //Change speed pin
...
void loop() 
{
  ...
  lcd.print(" White=Speed: "); // pad with spaces for centering
...
//  lcd.noBlink();
  ...
  } //wait on reset screen until blue button is pressed
